...
stDate DecreaseXDecadeFaster(stDate date, int NumberOfDecades) {
...
stDate DecreaseOneMillennium(stDate date) {
	// a millennium is 1000 year, or 100 decades
	return DecreaseXDecadeFaster(date, 100);
}
...
int main() {
	...
	PrintDate("Date After Millennium One Century: ", date);
