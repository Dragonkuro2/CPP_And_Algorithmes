...
int main() {
	stDate date;
	int NumberOfDaysToDecrease;

	date = ReadDate("Enter The Date: ");
	NumberOfDaysToDecrease = ReadPositiveNumber("Enter the number of days to decrease: ");
	date = DecreaseXDays(date, NumberOfDaysToDecrease);
	PrintDate("Date After Decreasing One Day: ", date);
