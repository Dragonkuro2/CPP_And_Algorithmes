...
void CopyArray(int array1[MAX_SIZE], int length, int array2[MAX_SIZE], int &length2) {
	for (int i = 0; i < length; i++) {
...
int main() {
	...
	CopyArray(array1, length, array2, length2);
	cout << "The array 2 after copying: " << endl;
